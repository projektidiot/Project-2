...
<!--	<link rel="stylesheet" href="http://code.jquery.com/mobile/1.0/jquery.mobile-1.0.min.css" /> -->
	...
	<? include("vote_counter.php"); ?>

</head>
<body>

<div class="container">
	 <form method="POST" action="hasvoted.php">
		...
		<div id="page1" data-role="page">
			...
			<div id="candidate1">
				<div class="transbox">
					...
					<input name="submit_Calvin" type="submit" id="Calvin" value="Vote for Calvin" />
		...
		<div id="page2" data-role="page">
			...
			<div id="candidate2">
				<div class="transbox">
					...
					<input name="submit_Sonic" type="submit" id="Sonic" value="Vote for Sonic" />
		...
		<div id="page3" data-role="page">
			...
			<div id="candidate3">
				<div class="transbox">
					...
					<input name="submit_Peach" type="submit" id="Princess Peach" value="Vote for Princess Peach" />
